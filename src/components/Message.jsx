import { UserRound, Send, CheckCheck } from 'lucide-react'
            ...
            {selectedUser ?
                <>
                    ...
                    <div className="relative flex flex-col justify-between flex-1 space-y-4 mt-10 px-6">
                        <div ref={messagesContainerRef} className='max-h-[600px] space-y-4 overflow-x-hidden overflow-y-auto'>
                            {messageList.map((msg) => {
                        ...
                        <div className="pb-4 w-full">
                            <div className='relative'>
                                <textarea
                                    ...
                                    className="w-full pr-16 border-none outline-none focus:border focus:border-blue-500 resize-none py-6 px-6 rounded-2xl bg-slate-800/80 bg-opacity-40 placeholder:text-[#A6ACBE] placeholder:font-lato placeholder:text-[16px] placeholder:not-italic placeholder:font-normal placeholder:leading-5"
